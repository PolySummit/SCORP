...
from gs2dgs.arguments import ModelParams, PipelineParams, get_combined_args
from gs2dgs.gaussian_renderer import render as render_2dgs
from gs3dgs.gaussian_renderer import render as render_3dgs
from gs2dgs.scene import Scene
from gs2dgs.scene.cameras import Camera
from gs2dgs.scene.gaussian_model import GaussianModel
from gs2dgs.utils.general_utils import TorchtoPIL, safe_state, PILtoTorch
from gs2dgs.utils.graphics_utils import fov2focal
...
def render_func_2dgs(pipeline, background):
    return lambda camera, gs, color: render_2dgs(
...
def align(
    ...
    render_f_2dgs = render_func_2dgs(pipeline, background)
    ...
    with torch.no_grad():
        for cam in tqdm(cam_list):
            ...
            if _mask_area > 0:
                ...
                _render_pkg = render_f_2dgs(cam, gaussian_original, None)
